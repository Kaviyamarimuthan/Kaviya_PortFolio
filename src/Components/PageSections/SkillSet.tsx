  ...
  return (
    <main className="page-wrapper">
      ...
      <ScrollReveal>
        ...
        >
          Two years of hands-on production experience across the full
          React/Next.js stack — from pixel-perfect UIs to auth systems and
          performance tuning.
        </p>
      </ScrollReveal>
              ...
              >
                <span
                  style={{
                    ...
                    fontSize: "0.95rem",
                    color:
                      cat.color === "cyan" ? "var(--cyan)" : "var(--purple)",
                  }}
                >
                  {cat.icon}
                </span>
      ...
      <ScrollReveal>
        ...
        >
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "0.6rem" }}>
            {learning.map((item) => (
              <span key={item} className="skill-tag-learning">
                {item}
              </span>
            ))}
          </div>
          ...
          >
            Expanding beyond frontend to become a more well-rounded engineer —
            backend fundamentals, DevOps basics, and scalable architecture
            patterns.
          </p>
        </div>
      </ScrollReveal>
